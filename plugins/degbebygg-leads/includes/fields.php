...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'degbebygg-leads' ),
				'storm'       => __( 'Storm or hail damage', 'degbebygg-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'degbebygg-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'degbebygg-leads' ),
				'not-sure'    => __( 'Vet inte än', 'degbebygg-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'degbebygg-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'degbebygg-leads' ),
				'research' => __( 'Jag kollar bara priser', 'degbebygg-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'degbebygg-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'degbebygg-leads' ),
		'contacted' => __( 'Kontaktad', 'degbebygg-leads' ),
		'quoted'    => __( 'Quote sent', 'degbebygg-leads' ),
		'won'       => __( 'Won', 'degbebygg-leads' ),
		'lost'      => __( 'Lost', 'degbebygg-leads' ),
		'spam'      => __( 'Misstänkt spam', 'degbebygg-leads' ),
	);
}
